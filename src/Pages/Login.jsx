    ...
    return (
        <div>
            <div className="hero min-h-screen">
                <div className="hero-content bg-linear-to-bl from-base-200 via-[#1a1a19ba] to-[#28D99D] flex-col lg:flex-row-reverse rounded-3xl">
                        ...
                        <div className="card-body min-h-96 md:w-96">
                            ...
                            <fieldset className="fieldset ">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="btn outline-0 border-0 primary-btn mt-4">Login</motion.button>
